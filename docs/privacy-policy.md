---
title: Web Remainder — Privacy Policy
---

# Web Remainder — Privacy Policy
...
- No external servers — no reminder content or browsing activity is transmitted
  anywhere.
...
- Delete individual reminders from the popup, dashboard, or on the page, or use
  Clear all data in Settings to remove everything at once.
...
`activeTab`, `contextMenus`, and access to the web pages you annotate. None of
this is used to collect or transmit your data.

## Contact

Questions? Open an issue at
[github.com/farukak/web-remainder](https://github.com/farukak/web-remainder).
